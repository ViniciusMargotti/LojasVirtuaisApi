...
// Não cheque essas requisições
                .authorizeRequests().antMatchers("/estados","/cidades","/bairros","/authenticate","/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/**", "/swagger-ui.html", "/webjars/**").permitAll().
